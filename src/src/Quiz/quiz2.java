...
//		2. 변수 city에 최종적으로 저장되는 수는 얼마인가? 4
//				int city=7; 7 
//				city+=7;  14
//				city-=2; 12
//				city*=5; 60
...
//		 6. 자동 타입 변환에 대한 내용입니다. 컴파일 에러가 발생하는 것은 무엇입니까? 3
//		 byte byteValue=10;
//		 char charValue=20;
//		 ① int intValue=byteValue;
//		 ② int intValue=charValue;
//		 ③ short shortValue=charValue; // 양수만 가능
...
//		 10. 다음 프로그램의 결과 값은? 양수
//		 int su=10;
//		 System.out.println(su> 0 ? "양수": "음수"); 
		 
//		 11. 다음 프로그램의 결과 값은?		  false
//		 boolean play=true;
//		 play=!play;
//		 System.out.println("play값은:" + play); 
